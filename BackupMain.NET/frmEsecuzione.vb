...
Public Class frmEsecuzione
    ...
    Private opeFileGlobale As OperazioniSuFile.OperazioniSuFile
    ...
    Public Sub ImpostaNomeProcedura(NFileLog As String, Nome As String, NumeroMaschera As Integer, opFile As OperazioniSuFile.OperazioniSuFile, clL As LogCasareccio.LogCasareccio.Logger)
